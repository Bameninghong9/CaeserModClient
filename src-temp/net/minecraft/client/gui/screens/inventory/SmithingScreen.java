...
public class SmithingScreen extends ItemCombinerScreen<SmithingMenu> {
	...
	public void containerTick() {
		...
		this.baseIcon.tick(optional.<List<Identifier>>map(SmithingTemplateItem::getBaseSlotEmptyIcons).orElse(List.of()));
		this.additionalIcon.tick(optional.<List<Identifier>>map(SmithingTemplateItem::getAdditionalSlotEmptyIcons).orElse(List.of()));
	}

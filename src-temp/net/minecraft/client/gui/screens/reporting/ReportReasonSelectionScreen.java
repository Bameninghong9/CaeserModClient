...
public class ReportReasonSelectionScreen extends Screen {
	...
	public class ReasonSelectionList extends ObjectSelectionList<ReportReasonSelectionScreen.ReasonSelectionList.Entry> {
		...
		public ReportReasonSelectionScreen.ReasonSelectionList.@Nullable Entry findEntry(ReportReason reportReason) {
		...
		public void setSelected(ReportReasonSelectionScreen.ReasonSelectionList.@Nullable Entry entry) {

...
public class ViewArea {
	...
	protected SectionRenderDispatcher.@Nullable RenderSection getRenderSectionAt(BlockPos blockPos) {
		return this.getRenderSection(SectionPos.asLong(blockPos));
	}

	protected SectionRenderDispatcher.@Nullable RenderSection getRenderSection(long l) {
	...
	private SectionRenderDispatcher.@Nullable RenderSection getRenderSection(int i, int j, int k) {

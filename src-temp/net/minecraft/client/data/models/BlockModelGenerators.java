...
public class BlockModelGenerators {
	...
	static net.minecraft.client.renderer.block.model.Variant plainModel(Identifier identifier) {
		return new net.minecraft.client.renderer.block.model.Variant(identifier);
	}

	static MultiVariant variant(net.minecraft.client.renderer.block.model.Variant variant) {
		return new MultiVariant(WeightedList.of(variant));
	}

	private static MultiVariant variants(net.minecraft.client.renderer.block.model.Variant... variants) {
	...
	@SafeVarargs
	private static <T extends Enum<T> & StringRepresentable> ConditionBuilder condition(EnumProperty<T> enumProperty, T enum_, T... enums) {
	...
	private static MultiVariant createRotatedVariants(net.minecraft.client.renderer.block.model.Variant variant) {
	...
	private static PropertyDispatch<MultiVariant> createBooleanModelDispatch(
		...
		return PropertyDispatch.<Boolean>initial(booleanProperty).select(true, multiVariant).select(false, multiVariant2);
	}
	...
	private void createBrushableBlock(Block block) {
		this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.<Integer>initial(BlockStateProperties.DUSTED).generate(integer -> {
	...
	static BlockModelDefinitionGenerator createButton(Block block, MultiVariant multiVariant, MultiVariant multiVariant2) {
		return MultiVariantGenerator.dispatch(block)
			.with(PropertyDispatch.<Boolean>initial(BlockStateProperties.POWERED).select(false, multiVariant).select(true, multiVariant2))
			.with(
	...
	static BlockModelDefinitionGenerator createFenceGate(
		...
		return MultiVariantGenerator.dispatch(block)
			.with(
				PropertyDispatch.<Boolean, Boolean>initial(BlockStateProperties.IN_WALL, BlockStateProperties.OPEN)
	...
	private void createCrossBlock(Block block, BlockModelGenerators.PlantType plantType, Property<Integer> property, int... is) {
		...
		this.registerSimpleFlatItemModel(block.asItem());
		this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.<Integer>initial(property).generate(integer -> {
	...
	private void createStems(Block block, Block block2) {
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(block)
					.with(
						PropertyDispatch.<Integer>initial(BlockStateProperties.AGE_7)
		...
		this.blockStateOutput
			.accept(
				MultiPartGenerator.multiPart(block)
					.with(function.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)), multiVariant)
					.with(function.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)), multiVariant.with(Y_ROT_90))
					.with(function.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)), multiVariant.with(Y_ROT_180))
					.with(function.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)), multiVariant.with(Y_ROT_270))
					.with(function2.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)), multiVariant2)
					.with(function2.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)), multiVariant2.with(Y_ROT_90))
					.with(function2.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)), multiVariant2.with(Y_ROT_180))
					.with(function2.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)), multiVariant2.with(Y_ROT_270))
					.with(function3.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)), multiVariant3)
					.with(function3.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)), multiVariant3.with(Y_ROT_90))
					.with(function3.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)), multiVariant3.with(Y_ROT_180))
					.with(function3.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)), multiVariant3.with(Y_ROT_270))
					.with(function4.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.NORTH)), multiVariant4)
					.with(function4.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.EAST)), multiVariant4.with(Y_ROT_90))
					.with(function4.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.SOUTH)), multiVariant4.with(Y_ROT_180))
					.with(function4.apply(condition().term(BlockStateProperties.HORIZONTAL_FACING, Direction.WEST)), multiVariant4.with(Y_ROT_270))
			);
	}
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.BARREL)
					.with(PropertyDispatch.<Boolean>initial(BlockStateProperties.OPEN).select(false, multiVariant).select(true, multiVariant2))
	...
	private void createCropBlock(Block block, Property<Integer> property, int... is) {
		...
		this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.<Integer>initial(property).generate(integer -> {
			int i = is[integer];
			return plainVariant(int2ObjectMap.computeIfAbsent(i, ix -> this.createSuffixedVariant(block, "_stage" + ix, ModelTemplates.CROP, TextureMapping::crop)));
		})));
	}
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.CAKE)
					.with(
						PropertyDispatch.<Integer>initial(BlockStateProperties.BITES)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.CRAFTER)
					.with(
						PropertyDispatch.<Boolean, Boolean>initial(BlockStateProperties.TRIGGERED, CrafterBlock.CRAFTING)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.END_PORTAL_FRAME)
					.with(PropertyDispatch.<Boolean>initial(BlockStateProperties.EYE).select(false, multiVariant).select(true, multiVariant2))
					.with(ROTATION_HORIZONTAL_FACING_ALT)
			);
	}
	...
	private static BlockModelDefinitionGenerator createCopperBulb(
		...
		return MultiVariantGenerator.dispatch(block)
			.with(PropertyDispatch.<Boolean, Boolean>initial(BlockStateProperties.LIT, BlockStateProperties.POWERED).generate((boolean_, boolean2) -> {
				if (boolean_) {
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.DAYLIGHT_DETECTOR)
					.with(
						PropertyDispatch.<Boolean>initial(BlockStateProperties.INVERTED)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.MANGROVE_PROPAGULE)
					.with(
						PropertyDispatch.<Boolean, Integer>initial(MangrovePropaguleBlock.HANGING, MangrovePropaguleBlock.AGE)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.FROSTED_ICE)
					.with(
						PropertyDispatch.<Integer>initial(BlockStateProperties.AGE_3)
	...
	private void createGrassLikeBlock(Block block, MultiVariant multiVariant, MultiVariant multiVariant2) {
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(block)
					.with(PropertyDispatch.<Boolean>initial(BlockStateProperties.SNOWY).select(true, multiVariant2).select(false, multiVariant))
			);
	}
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.COCOA)
					.with(
						PropertyDispatch.<Integer>initial(BlockStateProperties.AGE_2)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.REPEATER)
					.with(
						PropertyDispatch.<Integer, Boolean, Boolean>initial(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.SEA_PICKLE)
					.with(
						PropertyDispatch.<Integer, Boolean>initial(BlockStateProperties.PICKLES, BlockStateProperties.WATERLOGGED)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.SNOW)
					.with(
						PropertyDispatch.<Integer>initial(BlockStateProperties.LAYERS)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.TEST_BLOCK)
					.with(PropertyDispatch.initial(BlockStateProperties.TEST_BLOCK_MODE).generate(testBlockModex -> plainVariant(map.get(testBlockModex))))
			);
		this.itemModelOutput
			.accept(
				Items.TEST_BLOCK,
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.TRIPWIRE)
					.with(
						PropertyDispatch.<Boolean, Boolean, Boolean, Boolean, Boolean>initial(
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.TRIPWIRE_HOOK)
					.with(
						PropertyDispatch.<Boolean, Boolean>initial(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED)
							.generate(
	...
	private net.minecraft.client.renderer.block.model.Variant createTurtleEggModel(int i, String string, TextureMapping textureMapping) {
		return switch (i) {
			case 1 -> plainModel(
	...
	private net.minecraft.client.renderer.block.model.Variant createTurtleEggModel(int i, int j) {
		return switch (j) {
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.TURTLE_EGG)
					.with(
						PropertyDispatch.<Integer, Integer>initial(BlockStateProperties.EGGS, BlockStateProperties.HATCH)
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.DRIED_GHAST)
					.with(PropertyDispatch.<Integer>initial(DriedGhastBlock.HYDRATION_LEVEL).generate(integer -> plainVariant(function.apply(integer))))
					.with(ROTATION_HORIZONTAL_FACING)
			);
	}
	...
	private void createSnifferEgg() {
		...
		this.blockStateOutput
			.accept(MultiVariantGenerator.dispatch(Blocks.SNIFFER_EGG).with(PropertyDispatch.<Integer>initial(SnifferEggBlock.HATCH).generate(integer -> {
				String string = switch (integer) {
	...
	private void createMultifaceBlockStates(Block block) {
		...
		ConditionBuilder conditionBuilder = condition();
		map.forEach((property, variantMutator) -> conditionBuilder.term((Property<Boolean>)property, false));
		MultiVariant multiVariant = plainVariant(ModelLocationUtils.getModelLocation(block));
		MultiPartGenerator multiPartGenerator = MultiPartGenerator.multiPart(block);
		map.forEach((property, variantMutator) -> {
			multiPartGenerator.with(condition().term((Property<Boolean>)property, true), multiVariant.with(variantMutator));
	...
	private void createHangingMoss(Block block) {
		this.registerSimpleFlatItemModel(block);
		this.blockStateOutput.accept(MultiVariantGenerator.dispatch(block).with(PropertyDispatch.<Boolean>initial(HangingMossBlock.TIP).generate(boolean_ -> {
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.SCULK_CATALYST)
					.with(PropertyDispatch.<Boolean>initial(BlockStateProperties.BLOOM).generate(boolean_ -> boolean_ ? multiVariant2 : multiVariant))
			);
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(Blocks.RESPAWN_ANCHOR)
					.with(PropertyDispatch.<Integer>initial(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate(integer -> plainVariant(identifiers[integer])))
			);
	...
	private void createHead(Block block, Block block2, Type type, Identifier identifier) {
	...
	private void createCopperGolemStatue(Block block, Block block2, WeatherState weatherState) {
		MultiVariant multiVariant = plainVariant(
	...
	private void createCandleAndCandleCake(Block block, Block block2) {
		...
		this.blockStateOutput
			.accept(
				MultiVariantGenerator.dispatch(block)
					.with(
						PropertyDispatch.<Integer, Boolean>initial(BlockStateProperties.CANDLES, BlockStateProperties.LIT)
	...
	class BlockFamilyProvider {
		...
		private Identifier getOrCreateModel(ModelTemplate modelTemplate, Block block) {
			return this.models.computeIfAbsent(modelTemplate, modelTemplatex -> modelTemplatex.create(block, this.mapping, BlockModelGenerators.this.modelOutput));
		}
	...
	enum PlantType {
		...
		PlantType(final ModelTemplate modelTemplate, final ModelTemplate modelTemplate2, final boolean bl) {
